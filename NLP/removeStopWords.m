function s = removeStopWords(str)
stopwords_cellstring={'a', 'about','able', 'above', 'above', 'across', 'after', ...
...
split1 = regexp(str,'\s','Split');
s = strjoin(split1(~ismember(split1,stopwords_cellstring)),' ');
end
